#language: fr
Fonctionnalité: Transfert de parts sans règle de l'achat - test de la consolidation

  Contexte:
    Etant donnée une part de propriété 1/1 d'identifiant 16-16-pp1 sur la parcelle 16-16 pour la personne 1
  ...
  Scénario: Valeurs terrain consolidées
    ...
    Etant donnée une part cédée 16-16-pp1 à hauteur de 1/4
