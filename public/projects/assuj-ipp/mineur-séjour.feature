#language: fr
Fonctionnalité: Assujettissement des mineurs en séjour

  Scénario: Mineur séjour sans activité
    Etant donné que la date du jour est le 01.01.2020
    Et que le calcul de l'assuj IPP concerne la personne 123456789
    Et que la personne RF est définie par date de naissance 25.08.2005 état vital VIVANT type de résidence GENEVE activite SANS statut indépendant AUCUN type de permis SEJOUR statut propriétaire NON_PROPRIETAIRE
  ...
  Scénario: Mineur séjour avec activité
    Etant donné que la date du jour est le 01.01.2020
    Et que le calcul de l'assuj IPP concerne la personne 123456789
