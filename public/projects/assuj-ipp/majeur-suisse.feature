#language: fr
Fonctionnalité: Assujettissement des majeurs Suisses
  ...
  Scénario: avec activité dépendente, indépendante et proprietaire
    Etant donné que la date du jour est le 01.01.2020
    Et que le calcul de l'assuj IPP concerne la personne 123456789
    Et que la personne RF est définie par date de naissance 25.08.1980 état vital VIVANT type de résidence GENEVE activite AVEC statut indépendant INDEPENDANT type de permis ETABLI statut propriétaire PROPRIETAIRE
    Et que le revenu est 100000
    Et qu'il n'existe pas de demande TOU
    Et que l'assujIpp intiale est type AUCUN étendue AUCUN mode d'imposition AUCUN
    Lorsque le moteur de calcul est lancé pour la date du jour
